        ...
        <nav className="flex items-center gap-6 justify-start md:justify-center bg-primary py-2 sm:py-4 px-6">
            ...
            <ul className="flex gap-4 items-center" tabIndex={drawer ? -1 : undefined}>
                ...
                <li className="hidden sm:block">
                    <Link href='/' data-active={currentPath === '/'} className='data-[active=true]:underline'>Páginal inicial</Link>
                </li>
            ...
            <div
                ...
                className="fixed top-0 left-0 bottom-0 right-0 bg-gradient-to-r from-background transition-transform data-[open=false]:-translate-x-full"
            >
                <ul
